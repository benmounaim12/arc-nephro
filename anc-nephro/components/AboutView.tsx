        ...
        {tab === 'Organigramme' && (
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-2xl border-2 border-red-200 p-4 flex items-center gap-3">
              <div className="w-14 h-14 rounded-full bg-red-600 flex items-center justify-center text-white font-bold text-base flex-shrink-0">
                NK
              </div>
              <div className="flex-1">
                <span className="bg-red-100 text-red-700 text-xs font-bold px-2 py-0.5 rounded-full">Présidente</span>
                <p className="text-sm font-bold text-gray-900 mt-1">Pr. Nadia Kabbali</p>
              </div>
            </div>
        ...
        {tab === 'Historique' && (
          <div className="space-y-3">
            ...
            {[
              ...
              { year:'2010', title:'Adhésion à la SMN', desc:'L\'ARC rejoint officiellement la Société Marocaine de Néphrologie.', highlight:false },
              ...
              { year:'2020', title:'Transition numérique', desc:'Lancement des webinaires et des formations en ligne.', highlight:false },
