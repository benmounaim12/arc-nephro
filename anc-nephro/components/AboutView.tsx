...
const BUREAU = [
  { titre:'Présidente',             nom:'Pr. Nadia Kabbali',        initiales:'NK', color:'bg-red-600' },
  { titre:'Vice-Présidente',        nom:'Pr. Basmat Amal Chouhani', initiales:'BC', color:'bg-blue-600' },
  { titre:'Secrétaire Générale',    nom:'Dr. Ghita El Yousfi',      initiales:'GY', color:'bg-green-600' },
  { titre:'Vice-Secrétaire Générale', nom:'Dr. Mouna El Mansouri',  initiales:'MM', color:'bg-purple-600' },
  { titre:'Trésorière',             nom:'Dr. Souad Mikou',          initiales:'SM', color:'bg-amber-600' },
  { titre:'Vice-Trésorière',        nom:'Dr. Wiam Rami',            initiales:'WR', color:'bg-teal-600' },
  { titre:'Assesseur',              nom:'Dr. Fatimazahra Harrat',   initiales:'FH', color:'bg-pink-600' },
];
  ...
  return (
    <div className="flex-1 overflow-y-auto pb-20 flex flex-col">
      ...
      <div className="px-4 pb-4">
        ...
        {tab === 'Organigramme' && (
          <div className="space-y-3">
            <div className="bg-navy rounded-2xl p-4 border border-blue-800 mb-2">
            ...
            {/* Présidente en évidence */}
            <div className="bg-white rounded-2xl border-2 border-red-200 p-4 flex items-center gap-3">
              ...
              <div className="flex-1">
                <span className="bg-red-100 text-red-700 text-xs font-bold px-2 py-0.5 rounded-full">{BUREAU[0].titre}</span>
        ...
        {tab === 'Historique' && (
          <div className="space-y-3">
            ...
            {[
              { year:'2001', title:'Fondation de l\'ARC', desc:'Création de l\'Association Rénale du Centre par un groupe de néphrologues pionniers de la région.', highlight:false },
              { year:'2005', title:'Première réunion scientifique', desc:'Organisation de la première réunion scientifique annuelle, devenue un événement incontournable.', highlight:false },
              { year:'2010', title:'Adhésion à la SMN', desc:'L\'ARC rejoint officiellement la Société Marocaine de Néphrologie et renforce ses liens institutionnels.', highlight:false },
              { year:'2015', title:'Expansion régionale', desc:'Extension du réseau de membres à l\'ensemble des provinces de la région du Centre.', highlight:false },
              { year:'2020', title:'Transition numérique', desc:'Lancement des webinaires et des formations en ligne suite à la pandémie COVID-19.', highlight:false },
              { year:'2024', title:'Lancement ARC Néphro App', desc:'Développement de l\'application mobile ARC Néphro avec KiliA, l\'assistant IA spécialisé en néphrologie.', highlight:false },
              ...
              <div key={e.year} className="flex gap-3">
                ...
                <div className={`flex-1 pb-3 rounded-xl p-3 ${e.highlight ? 'bg-amber-50 border border-amber-200' : 'bg-white border border-gray-100'}`}>
